<?php
	$adresa="1211 Vine St, Cincinnati,OH 45202,United States"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=5138348670;// Broj koji se poziva na dugme CALL US
